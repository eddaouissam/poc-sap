...
AGGVBPAITEM AS (
  ...
  FROM sap_silver.s_vbpa AS VBPA
  INNER JOIN sap_silver.s_kna1 AS KNA1
    ON
...
FROM sap_silver.s_vbak AS VBAK
INNER JOIN sap_silver.s_vbap AS VBAP
...
LEFT OUTER JOIN sap_silver.s_vbuk AS VBUK
