...
-- and "negative" for credit
  ...
  FROM BSEG AS BSEG
  INNER JOIN sap_silver.s_bkpf AS BKPF
  ...
  LEFT JOIN DEV_DB_VISEO.UTILS.CURRENCY_DECIMAL AS TCURXWAERS
    ON BKPF.WAERS = TCURXWAERS.CURRKEY
  LEFT JOIN DEV_DB_VISEO.UTILS.CURRENCY_DECIMAL AS TCURXHWAER
    ON BKPF.HWAER = TCURXHWAER.CURRKEY
  LEFT JOIN DEV_DB_VISEO.UTILS.CURRENCY_DECIMAL AS TCURXHWAE2
    ON BKPF.HWAE2 = TCURXHWAE2.CURRKEY
  LEFT JOIN DEV_DB_VISEO.UTILS.CURRENCY_DECIMAL AS TCURXHWAE3
    ON BKPF.HWAE3 = TCURXHWAE3.CURRKEY
  LEFT JOIN DEV_DB_VISEO.UTILS.CURRENCY_DECIMAL AS TCURXPSWSL
