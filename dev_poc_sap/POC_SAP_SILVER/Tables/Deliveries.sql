...
FROM sap_silver.s_lips AS lips
INNER JOIN sap_silver.s_likp AS likp
  ON
...
LEFT JOIN utils.calendar_date_dim AS CalendarDateDimension_LFDAT
  ON CalendarDateDimension_LFDAT.Date = likp.LFDAT
LEFT JOIN utils.calendar_date_dim AS CalendarDateDimension_PODAT
