SELECT SO.Client_MANDT,
  ...
  mat.Language_SPRAS
FROM sap_gold.SDDocumentFlow AS SO
INNER JOIN sap_gold.SalesOrders AS vbap
...
LEFT OUTER JOIN sap_gold.SDStatus_Items AS del_status
